...
<template>
  <div class="flex m-0 gap-4 mt-4 py-2">
    <div v-for="myTag in selectedTags"
      class="relative group border-2 shadow-sm font-semibold text-blue-500 bg-blue-600/10 rounded-lg px-1.5 py-1 inline-flex items-center justify-center border-blue-500"
      :key="myTag">
    ...
    <select aria-label="Tag Select" :modelValue="null" @change="addTagWithEvent"
